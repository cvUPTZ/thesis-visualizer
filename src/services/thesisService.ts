...
export const thesisService = {
  ...
  async getThesis(thesisId: string): Promise<Thesis | null> {
    try {
      ...
      const parsedContent = thesisContentSchema.parse(typeof data.content === 'string' ? JSON.parse(data.content) : data.content);
      ...
      const thesisData: Thesis = {
        id: data.id,
            metadata: {
               ...
               createdAt: parsedContent.metadata.createdAt,
